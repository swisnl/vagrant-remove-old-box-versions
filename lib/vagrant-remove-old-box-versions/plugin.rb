begin
  ...
  raise "The Vagrant remove-old-versions plugin must be run within Vagrant."
end

# This is a sanity check to make sure no one is attempting to install
# this into an early Vagrant version.
if Vagrant::VERSION < "1.2.0"
  raise "The Vagrant remove-old-versions plugin is only compatible with Vagrant 1.2+"
end
...
module VagrantPlugins
  module RemoveOldVersions
    class Plugin < Vagrant.plugin("2", :command)
